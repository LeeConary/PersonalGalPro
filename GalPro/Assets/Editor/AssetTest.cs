...
public class AssetTest : MonoBehaviour
{
    ...
    {
        string path = Path.Combine(Application.streamingAssetsPath, "myAssetBundle.unity3d");
        if (path.Length != 0)
        {
    ...
    {
        UnityWebRequest request = UnityWebRequestAssetBundle.GetAssetBundle(Path.Combine(Application.streamingAssetsPath , "myAssetBundle.unity3d"));
